(() => {
  globalThis.HoofersSlideshowImages = [
  {
    "src": "assets/slideshow/01-the-tong-family-marina.jpg",
    "title": "The Tong Family Marina",
    "description": "Young sailors begin their lake adventures from the heart of the Hoofer Sailing Club.",
  ...
  },
  {
    ...
    "title": "Image 10 Caption",
    "description": "Image 10 Description",
    "alt": "Youth sailing: Image 10 Caption"
  },
  {
    "src": "assets/slideshow/IMG6890960302933409169.jpg",
    "title": "Image 11 Caption",
    "description": "Image 11 Description",
    "alt": "Youth sailing: Image 11 Caption"
  }
];
})();
